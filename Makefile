# This Makefile is intended *only* for building macOS binaries of DevForge.
...
app: $(APP_NAME)-native ## Create a DevForge.app
app-universal: $(APP_NAME)-universal ## Create a universal DevForge.app
$(APP_NAME)-%: $(TARGET)-%
	...
	xattr -c $(APP_DIR)/$(APP_NAME)/Contents/Resources/devforge.icns
...
dmg: $(DMG_NAME)-native ## Create a DevForge.dmg
dmg-universal: $(DMG_NAME)-universal ## Create a universal DevForge.dmg
$(DMG_NAME)-%: $(APP_NAME)-%
