# How to contribute
Thank you for your interest in contributing to Lapce! No contribution is too small and we consider _all_ contributions to the project. There are many ways to contribute (a few are listed here) but if you think of something else, join us on [Discord](https://discord.gg/n8tGJ6Rn6D) or let us know via an [issue](https://github.com/bimacoding/DevForge/issues).

## Questions

We're always around hanging on our [Discord](https://discord.gg/n8tGJ6Rn6D) server but if you're only participating on GitHub, you can open a [Discussion](https://github.com/bimacoding/DevForge/discussions)

## Feature Requests

A feature request is _editor behaviour that you want to have included in Lapce_. We track feature requests on GitHub via [issues](https://github.com/bimacoding/DevForge/issues). There are generally few kinds of features:

### Core features

A feature more suited to the core development of Lapce. If this is the case please make a suggestion in an [issue](https://github.com/bimacoding/DevForge/issues).
...
There is main issue for tracking syntax highlighting grammars support at https://github.com/bimacoding/DevForge/issues/272.
...
Bugs should also be reported on GitHub via [issues](https://github.com/bimacoding/DevForge/issues). This allows us to track them and see how prevalent they are.
...
If you want to write some code, develop the documentation, or otherwise work on a certain feature or bug, let us know by replying to or creating an [issue](https://github.com/bimacoding/DevForge/issues).
